...
,
		"rect" : [ 116.0, 138.0, 673.0, 562.0 ],
		"bgcolor" : [ 0.882353, 0.862745, 0.835294, 1.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 193.0, 140.0, 40.0, 20.0 ],
					"text" : "zl.reg"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 163.25, 120.0, 32.5, 20.0 ],
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 177.75, 183.0, 43.0, 20.0 ],
					"text" : "zl mth"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 193.0, 88.0, 46.0, 21.0 ],
					"text" : "jit.spill"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 50.0, 96.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 472.0, 111.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 429.5, 243.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 405.0, 407.0, 105.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 405.0, 135.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 400.0, 250.0, 95.0 ],
...
,
					"patching_rect" : [ 286.0, 503.0, 102.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 286.0, 523.379517, 143.5, 18.0 ],
					"text" : "bgcolor"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 346.0, 314.0, 15.0 ],
					"text" : "linesegment $1 $6 $2 $6 255 0 0, linesegment $5 $3 $5 $4 255 0 0, write $7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.0, 282.0, 100.0, 17.0 ],
